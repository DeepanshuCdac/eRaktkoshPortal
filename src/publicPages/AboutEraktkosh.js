            ...
            <div className="row">
              <div className="col-12 col-xl-8 col-lg-8 col-md-8 col-sm-8 mb-3">
                ...
                <p className="text_section mb-0">
                  eRaktkosh was Inaugurated on 7th April 2016 by Hon'ble
                  Minister of Health and Family Welfare, Sh. JP Nadda.
                </p>
                <br></br>
                <p className="text_section mb-0">
                  e-Raktkosh enforces Drug & Cosmetic Act, National Blood Policy
                  standards and guidelines ensuring proper collection &
                  donation, effective management and monitoring the quality and
                  quantity of the donated blood. Considering the national roll
                  out, e-Raktkosh has been developed with modular and scalable
                  ...
                  <div className="row">
                    ...
                    <div className="col-4">
                      <div className="mb-3 text-center">
                        <img
                          style={{ width: "26px", height: "26px" }}
                          src={`${process.env.PUBLIC_URL}/assets/images/networking.jpg`}
                          alt="eRaktkosh"
                          className="img-fluid"
                        />
                        <p className="mb-0 text_section">
            ...
            <div>
              <div className="details_section p-3 mt-4 pb-0 pe-0">
                <h3 className="header-page mb-2">
                  e-Raktkosh has six major components for management of the
                  blood donation life cycle
                </h3>
                <div className="d-flex" style={{ position: "relative" }}>
                  <ul className="text_section mb-0" style={{ padding: "1rem" }}>
                    ...
                    <li className="text_section mb-2">
                      It provides features such as blood grouping, TTI
                      screening, antibody screening, component preparation etc.
                      as per the defined processes and rules.
                    </li>
                    <li className="text_section mb-2">
                      A Centralized Blood inventory Management System for
                      keeping track of the blood stock across numerous blood
                      centers.
                    </li>
                    <li className="text_section mb-2">
