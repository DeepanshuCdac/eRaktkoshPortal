                ...
                <div className="body mb-4 align-items-center py-2">
                    {isCreatingAbha ? (
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            <label><span style={{ color: "red" }}>*</span> Verify Via:</label>
                            <Select
                                showSearch
                            ...
                            />
                            <Input onChange={(e) => setAdharInput(e.target.value)} style={{ width: "25%" }} placeholder="Enter Aadhaar Number" />
                            <Input onChange={(e) => setMobileInput(e.target.value)} style={{ width: "25%" }} placeholder="Enter Mobile Number" />
                            <Button onClick={handleSubmit} type="primary" style={{ marginRight: "10px" }}>Submit</Button>
                        </div>
                    ) : (
                        ...
                        <div className="row align-items-center">
                            <div className="col-8">
                                <div className="d-flex align-items-center justify-content-between">
                                    ...
                                    />
                                    <Input value={verificationInput} onChange={(e) => setVerificationInput(e.target.value)} style={{ width: "35%" }} placeholder="abc@abdm"/>
                                    <Button onClick={handleVerification} type="primary">Verify</Button>
                                </div>
                            </div>
                            <div className="col-1">
                            ...
                            <div className="col-3">
                                <Button type="primary" onClick={() => setIsCreatingAbha(true)}>Create ABHA Number</Button>
                            </div>
                        </div>
                    )}
                </div>
                <div>
                    <p><span style={{ color: "red" }}>*</span> I hereby declare that:
                        <Button className="ms-3" onClick={handleShowData} type="primary">
                            {isTextVisible ? "Hide" : "Show"}</Button>
                    </p>
                </div>
                {isTextVisible && (
